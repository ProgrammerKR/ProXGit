...
import (
	...
	"code.proxgit.io/proxgit/modules/label"
	...
	"code.proxgit.io/proxgit/modules/uri"
...
// GiteaLocalUploader implements an Uploader to proxgit sites
...
// NewGiteaLocalUploader creates an proxgit Uploader via proxgit API v1
